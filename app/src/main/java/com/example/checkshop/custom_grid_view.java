...
public class custom_grid_view extends BaseAdapter {
    private Context mContext;
    private final String[] web;
    private final int[] Imageid;

    public custom_grid_view(Context c, String[] web, int[] Imageid) {
        mContext = c;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            TextView textViewt = (TextView) grid.findViewById(R.id.textView4);
